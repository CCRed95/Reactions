...
namespace Reactions.Triggers
{
    ...
    //        set
    //        {
    //            this.SetValue(SourceNameProperty, (object)value);
    //        }
    //    }
    ...
    //                return this.ReadLocalValue(SourceNameProperty) != DependencyProperty.UnsetValue;
    //            else
    //                return true;
    //        }
    //    }
    ...
    //    static ReactiveEventTriggerBase()
    //    {
    //    }

    //    internal ReactiveEventTriggerBase()
    //    {
