...
{
	public class SimplePropertyChangedTrigger : ReactiveTriggerBase
	{
		...
		public static readonly DependencyProperty SourceObjectProperty = DP.Register(
			new Meta<SimplePropertyChangedTrigger, DependencyObject>(null, onSourceObjectChanged));
		...
		public static readonly DependencyProperty BoundValueProperty = DP.Register(
			new Meta<SimplePropertyChangedTrigger, object>(null, onBoundValueChanged));
		...
		private static void onSourceObjectChanged(SimplePropertyChangedTrigger i, DPChangedEventArgs<DependencyObject> e)
		{
			i.Source = e.NewValue;
		}

		private static void onBoundValueChanged(SimplePropertyChangedTrigger i, DPChangedEventArgs<object> e)
		{
			i.UpdateTriggerState();
		}
		//TODO Source set twice! before is null switch
