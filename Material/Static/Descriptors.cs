...
namespace Material.Static
{
	public static class Descriptors
	{
		...
		public static LuminosityMaterialDescriptor A100Descriptor = new LuminosityMaterialDescriptor(Luminosity.A100);
		public static LuminosityMaterialDescriptor A200Descriptor = new LuminosityMaterialDescriptor(Luminosity.A200);
		public static LuminosityMaterialDescriptor A400Descriptor = new LuminosityMaterialDescriptor(Luminosity.A400);
		public static LuminosityMaterialDescriptor A700Descriptor = new LuminosityMaterialDescriptor(Luminosity.A700);
		...
		public static LuminosityMaterialDescriptor A100O50Descriptor = new LuminosityMaterialDescriptor(Luminosity.A100, .5);
		public static LuminosityMaterialDescriptor A200O50Descriptor = new LuminosityMaterialDescriptor(Luminosity.A200, .5);
		...
		public static LiteralMaterialDescriptor WhiteDescriptor = new LiteralMaterialDescriptor(Palette.White000);
		public static LiteralMaterialDescriptor BlackDescriptor = new LiteralMaterialDescriptor(Palette.Black000);
		public static LiteralMaterialDescriptor TransparentDescriptor = new LiteralMaterialDescriptor(Palette.Transparent000);
		public static LiteralMaterialDescriptor White000O10Descriptor = new LiteralMaterialDescriptor(Palette.White000, .1);
		public static LiteralMaterialDescriptor White000O05Descriptor = new LiteralMaterialDescriptor(Palette.White000, .05);
	}
}
