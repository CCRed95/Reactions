...
using Material.Controls.Assists;
...
namespace Material.Markup.Converters
{
	public class ShadowConverter : IValueConverter
	{
		...
		{
			var resourceDictionary = new ResourceDictionary { Source = new Uri("pack://application:,,,/Material;component/Themes/Material.Shadows.xaml", UriKind.Absolute) };
