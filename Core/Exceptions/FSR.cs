...
namespace Core.Exceptions
{
	public class FSR
	{
		...
		{
			public static string IdentifierMustStartWithLetter(char value)
				=> $"Identifier character {value} is not valid. Identifiers must start with a letter and contain only alphanumeric characters.";

			public static string CannotParseIdentifier()
