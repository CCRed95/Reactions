...
{
	public class CornerAnimation : CornerAnimationBase
	{
		...
		internal void ReflSetValueInternal(DependencyProperty property, object value)
		{
			this.TryInvokeInternalMethod<DependencyProperty, object>("SetValueInternal", property, value);
		}
		...
		public CornerAnimation(CornerRadius toValue, Duration duration)
      : this()
    {
      ...
      : this()
    {
		...
		private static void AnimationFunction_Changed(DependencyObject d, DependencyPropertyChangedEventArgs e)
		{
			...
			if (!thicknessAnimation.TryInvokeInternalMethod(propertyChangedMethod, property))
			{
